export default function Skeleton() {
  return (
    <div className="flex flex-col justify-between h-84 w-80 outline outline-gray-300 rounded-md">
      <div className="bg-slate-100 pt-10 py-6 rounded-[inherit]">
        ...
        <div className="skeleton h-4 w-60 rounded-sm ml-6 mt-2"></div>
        <div className="skeleton h-4 w-60 rounded-sm ml-6 mt-2"></div>
        <div className="skeleton h-4 w-20 rounded-sm ml-6 mt-2"></div>
      </div>
