export default function Skeleton() {
    return (
        <div className="flex flex-col justify-between h-92 w-80 outline outline-gray-300 rounded-md">
            <div className="skeleton w-full h-48  rounded-t-[inherit] rounded-b-none"></div>
            <div className="bg-slate-100 pt-4 rounded-b-[inherit]">
