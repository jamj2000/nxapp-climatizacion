...
export default function TarjetaRecinto({ recinto }) {
  
  // console.log(recinto);
  
  return (
    <>
      <div className=" w-full max-w-md rounded-lg bg-gradient-to-tr dark:from-sky-100 dark:to-sky-400 from-gray-300 to-blue-500 p-0.5 shadow-lg">
        ...
        <div className="bg-gray-100 dark:bg-gray-900/90 p-7 rounded-md">
          ...
          <div className="flex justify-around flex-col">
            ...
            <p> {"Temperatura verano: " + recinto?.t_ver_relativa ?? "Sin definir"} </p>
            <p> {"Humedad verano: " + recinto?.hr_ver_relativa ?? "Sin definir"} </p>
            <p> {"Temperatura invierno: " + recinto?.t_inv_relativa ?? "Sin definir"} </p>
            <p> {"Humedad invierno: " + recinto?.hr_inv_relativa ?? "Sin definir"} </p>
