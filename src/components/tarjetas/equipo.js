...
export default async function TarjetaEquipo({ equipo }) {
  ...
  return (
    <>
      <div className=" w-full max-w-md rounded-lg bg-gradient-to-tr dark:from-sky-100 dark:to-sky-400 from-gray-300 to-blue-500 dark:bg-gray-800 p-0.5 shadow-lg">
