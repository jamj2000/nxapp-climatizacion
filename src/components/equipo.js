...
import { modificarEquipo, eliminarEquipo, noAction } from "@/lib/actions/equipo"
import { auth } from "@/auth";

export default async function Equipo({ equipo, proyectos }) {
      ...
      <div className=" w-full max-w-xs rounded-lg bg-gradient-to-tr dark:from-sky-100 dark:to-sky-400 from-gray-300 to-blue-500 dark:bg-gray-800 p-0.5 shadow-lg">
        ...
        <div className="flex justify-around gap-1 py-4">
          ...
          <Modal icon={<FaEye size='1rem' color='white' />} text='Ver'
            ...
            <Form id={'equipo-view-' + equipo.id} user={user} action={noAction} data={data} disabled={true} text="Cerrar" />
          </Modal>
          ...
          <Modal icon={<FaPen size='1rem' color='white' />} text='Editar'
            ...
            <Form id={'equipo-update-' + equipo.id} user={user} action={modificarEquipo} data={data} disabled={false} text="Actualizar este equipo" />
          </Modal>
          ...
          <Modal icon={<FaTrash size='1rem' color='white' />} text='Eliminar'
            ...
            <Form id={'equipo-delete-' + equipo.id} user={user} action={eliminarEquipo} data={data} disabled={true} text="Eliminar este equipo" />
          </Modal>
