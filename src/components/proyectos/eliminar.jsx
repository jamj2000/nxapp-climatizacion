...
import { eliminarProyecto } from "@/lib/actions/proyecto";
import { toast } from "sonner";
import { CircleHelp } from "lucide-react";



function ProyectoEliminar({ proyecto }) {
    const formId = useId()
    const [state, action, pending] = useActionState(eliminarProyecto, {})
        ...
        <form id={formId} action={action}>
            ...
            <div className="flex flex-col gap-4 justify-between items-center mb-4 md:flex-row">
                <button disabled={pending}
                    ...
                    {pending ? <Spinner /> : 'Eliminar proyecto'}
                </button>
            </div>
...
export default ProyectoEliminar
