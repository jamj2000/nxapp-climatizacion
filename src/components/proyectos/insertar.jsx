...
export function ProyectoInsertar({ localidades, user }) {
    const formId = useId()
    const [state, action, pending] = useActionState(insertarProyecto, {})
        ...
        <form id={formId} action={action}>
            ...
            <div className="flex flex-col gap-4 justify-between items-center mb-4 md:flex-row">
                <button disabled={pending}
                    ...
                    {pending ? <Spinner /> : 'Nuevo proyecto'}
                </button>
            </div>
...
export default ProyectoInsertar;
